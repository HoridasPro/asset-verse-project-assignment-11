        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-10">
          {benefits.map((item, index) => (
            <motion.div
              ...
              transition={{ duration: 0.6, delay: index * 0.1 }}
              viewport={{ once: true }}
              className="bg-[#DBE5FF] rounded-2xl p-6 shadow-md hover:shadow-xl transition"
            >
              <div className="w-12 h-12 flex items-center justify-center rounded-xl  text-indigo-600 mb-4">
                {item.icon}
              </div>
