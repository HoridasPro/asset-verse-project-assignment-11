...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-[#13182E] via-[#1F2A4D] to-[#2B3C6A] text-white py-16">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-10">
        <div>
          <h3 className="text-2xl font-bold mb-4">AssetVerse</h3>
        ...
        <div>
          ...
          <form className="flex gap-2">
            <input
              type="email"
              placeholder="horidas@gmail.com"
              className="px-4 py-2 rounded-l-lg text-white w-full"
            />
            <button
              type="submit"
              className="bg-white text-[#13182E] px-3 py-2 rounded-r-lg font-semibold hover:bg-gray-100 transition"
            >
              Subscribe
            </button>
          </form>
